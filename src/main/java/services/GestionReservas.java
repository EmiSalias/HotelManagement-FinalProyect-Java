...
public class GestionReservas implements Gestionable_I<Reserva> {
    ...
    private Usuario buscarUsuario(String nombreUsuario) {
        return GestionUsuario.getInstancia("usuarios.json").getUsuarios().stream()
    ...
    private Habitacion buscarHabitacion(String habitacionId) {
        return GestionHabitaciones.getInstancia("habitaciones.json").getHabitaciones().stream()
    ...
    private void guardarReservaYHabitacion(Reserva reserva, Habitacion habitacion) {
        try {
            ...
            GestionHabitaciones.getInstancia("habitaciones.json").actualizarHabitacion(habitacion);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void actualizarReservasJson() {
        try {
            ...
            GestionJSON.guardarReservasJson(reservasFiltradas, "reservas.json");
