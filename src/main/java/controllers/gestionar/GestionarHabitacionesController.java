...
public class GestionarHabitacionesController extends BaseController {
    ...
    private void cargarHabitaciones() {
        ...
        this.gestionHabitaciones = GestionHabitaciones.getInstancia("habitaciones.json");
    ...
    private void eliminarHabitacion() {
        ...
        if (habitacionSeleccionada != null) {
            ...
            List<Reserva> reservasAsociadas = GestionReservas.getInstancia("reservas.json").obtenerReservasNoCanceladas()
                    .stream()
